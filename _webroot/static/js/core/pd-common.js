 ...
 * DESC : JQuery 함수 모음
 * VER  : 1.2
 * Copyright 2017 Joins Group All rights reserved
 * ============================================================================================
 *                변   경   사   항
 * ============================================================================================
 ...
 */
PD_Common.getHttpRequest = function(_mimeType) {
  ...
  if (window.ActiveXObject || "ActiveXObject" in window) {
    ...
    if (_mimeType == 'text/xml') {
      // try { httpRequest.responseType = 'msxml-document'; } catch(e){}
    }
  } else {
    httpRequest = new XMLHttpRequest();
    httpRequest.overrideMimeType(_mimeType);
    /*
...
PD_Common.CreateMSXMLDocumentObject = function() {
  // if(typeof (ActiveXObject) != "undefined") {
  if (window.ActiveXObject || "ActiveXObject" in window) {
    var progIDs = [ "Microsoft.XMLDOM", "Microsoft.XMLHTTP", "Msxml2.DOMDocument.6.0", "Msxml2.DOMDocument.5.0", "Msxml2.DOMDocument.4.0", "Msxml2.DOMDocument.3.0", "MSXML2.DOMDocument", "MSXML.DOMDocument" ];
